...
$nor_id = $_SESSION['user_id'];

// Query the prof table to retrieve professional's information
$query = "SELECT * FROM user_form WHERE id = $nor_id";
...
<nav class="navbar">
        ...
        <ul class="nav-links">
          ...
          <div class="menu">
            ...
            if(isset($_SESSION['logged_in']) && isset($_SESSION['nor_image'])) {
    ...
    <div class="off">
        <h1>Welcome, <?php echo $normal['name']; ?></h1>
           <!-- Profile Image Section -->
           <form id="updateForm" action="update_nor_process.php" method="post" enctype="multipart/form-data">
            <!-- Profile Image Section -->
            <div class="profile-image-wrapper">
                <?php if ($normal['image']) : ?>
                    <img id="profileImage" src="<?php echo $normal['image']; ?>" alt=" Image">
                <?php else: ?>
        ...
        <!-- Form Fields Section -->
            ...
            <div class="form-field-container">
                ...
                <input type="text" id="name" name="name" value="<?php echo $normal['name']; ?>">
            ...
            <div class="form-field-container">
                ...
                <input type="email" id="email" name="email" value="<?php echo $normal['email']; ?>">
                <button class="update-button">
                    <span class="circle1"></span>
                    <span class="circle2"></span>
                    <span class="circle3"></span>
            ...
            <div class="form-field-container">
                <label for="job_tit">username:</label>
                <input type="text" id="job_tit" name="username" value="<?php echo $normal['username']; ?>">
                <button class="update-button">
                    <span class="circle1"></span>
                    <span class="circle2"></span>
                    <span class="circle3"></span>
